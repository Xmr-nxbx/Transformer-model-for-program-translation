...
module.exports = grammar({
  ...
  rules: {
    ...
    property_promotion_parameter: $ => seq(
      ...
      field('type', optional($._type)), // Note: callable is not a valid type here, but instead of complicating the codeparser, we defer this checking to any intelligence using the codeparser
      field('name', $.variable_name),
      optional(seq(
        '=',
